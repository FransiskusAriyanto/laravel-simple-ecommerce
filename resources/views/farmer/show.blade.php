...
<div class="row" style="padding-top: 80px; justify-content: center;">
        <div class="col-5 pb-2">
            ...
            @if(Auth()->user()->id == $product->user_id)
                <strong> Ini Product Anda </strong>
                <br></br>
                <button class="btn editproduct"><a href="/petani/produk">Lihat Produk</a> </button>
                @else
            ...
            @csrf
                ...
                <button class="btn editproduct" type="submit"> Pesan Produk </button>
            </form>
            @endif
            </div>
        </div>
